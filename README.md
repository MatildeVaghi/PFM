...
## Usage
 The "pfm_tutorial_MSC.m" script (located in the ~/PFM-Tutorial) calls multiple Matlab scripts for performing PFM. The code can be run using data from the MSC (available at https://openneuro.org/datasets/ds000224/versions/1.0.4) and adapted for other PFM-style datasets. Step-by-step instructions are outlined here: https://github.com/cjl2007/PFM-Depression/blob/main/PFM-Tutorial/pfm_tutorial_instructions.pdf
